      ...
      <v-row class="hidden-sm-and-down" no-gutters>
        ...
        <v-col md="10" sm="10" lg="10">
          <div style="margin:10px 0px 0px 110px;padding:0px 160px 0px 0px">
            <v-card flat>
              <v-toolbar flat>
                <v-btn @click="goBack" width="10%" color="#f66c1f" text>
            ...
            <v-row id="show" class="mb-6">
              <div v-if="newBook == true">
                <p>
                  <v-card flat style="margin-top:80px;margin-left:45px">
                    <div class="row">
                      <div class="column">
                        <v-btn
              ...
              <v-row v-else>
                <v-layout v-if="loading == false" style="text-align:center">
                  <v-main flat style="text-align:center">
                    ...
                    <v-btn rounded color="#f66c1f" to="/shelf">
                      Buy Books</v-btn
                    >
                  </v-main>
                </v-layout>
    ...
    <v-main class="hidden-md-and-up">
      ...
      >
        ...
        <div class="ml-4" v-if="newBook == true">
          <p>
            <v-card flat style="margin-top:40px;margin-left:10px">
              <div class="row">
                <div class="column4">
                  <v-btn
                    :to="`${stayBook.filetype}/${stayBook.slug}`"
...
export default {
    ...
    filteredBooks() {
      ...
      return this.books.filter(
        (book) =>
          ...
          unslugify(book.author)
            .toLowerCase()
            .indexOf(searchBooks) > -1
      );
    },
  },
  ...
  created() {
    firebase.auth().onAuthStateChanged((user) => {
      ...
      this.beneficiary = slugify(this.person.displayName, {
        replacement: "-",
        remove: /[$*_+~.()'"!:@]/g,
        lower: true,
      });
