...
<v-window v-model="step">
  ...
  <v-toolbar flat dark>
    ...
    <span v-if="data.title.length > 16">{{String(data.title).slice(0,16)}}...</span>
...
.darkOverlay{
  background-image:linear-gradient(to top right, rgba(0,0,0,1), rgba(0,0,0,1))
}
</style>
